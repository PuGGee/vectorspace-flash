package Weapons {
	...
	public class Lazer extends Linkable {
		...
		public function Lazer( listener:WorldController, weapon:Weapon, range:Number, power:Number ) {
		...
		public override function update():void {
			...
			var bodyPos:b2Vec2 = weapon.getWorldPosition();
			var direction:b2Vec2 = weapon.getDirection();
			var endPos:b2Vec2 = new b2Vec2( bodyPos.x + direction.x * 300, bodyPos.y + direction.y * 300 );
			...
			for ( var i:Number = 0; i < intersectionPoints.length; i++ ) {
			...
			if ( minPoint != -1 ) {
				...
				var force:b2Vec2 = weapon.getDirection();
				var angle:Number = vecToAngle( normal );
				force.Multiply( power * 20 );
